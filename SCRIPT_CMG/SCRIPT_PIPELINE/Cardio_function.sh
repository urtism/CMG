...
CARDIO_ALL () {
	...
	do
		...
		extract=$(echo $file| cut -d'_' -f 1,2,3) # Estraggo il nome del file come 20150716_01_Cardio
		...
		mv $INPUT/$extract\_L001_R1_001.fastq.gz $STORAGE/$Name_Dir
		mv $INPUT/$extract\_L001_R2_001.fastq.gz $STORAGE/$Name_Dir
...
#::::::::::::::::::::::::::::::::::::::::::     INIZIO VARIANT CALLING MULTI-SAMPLE     :::::::::::::::::::::::::::::::::::::::::::::::
	...
	printf "\n${DataRun}_Cardio_GATK.vcf : file multi-sample GATK in data $DataRun\n" >> $STORAGE/$Name_Dir/README.txt	
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::     FILTRAGGIO GATK     :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	...
	printf "\n${DataRun}_Cardio_GATK_Filter.vcf : contiene il file multi-sample filtrato sui parametri di GATK in data $DataRun\n" >> \
	$STORAGE/$Name_Dir/README.txt
...
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::     VARSCAN2     ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	...
	cp $DataRun\_Cardio_VarScan_Merge_Sort.vcf $STORAGE/$Name_Dir/$DataRun\_Cardio_VarScan.vcf
	printf "\n${DataRun}_Cardio_VarScan.vcf : contiene il file vcf multi-sample di VarScan in data $DataRun\n" >> $STORAGE/$Name_Dir/README.txt

	bgzip $DataRun\_Cardio_VarScan_Merge_Sort.vcf
	tabix $DataRun\_Cardio_VarScan_Merge_Sort.vcf.gz
