...
#Poi vado a prendere il vcf in ~/Scrivania/VCF-IEVA/NORM ed infine calcolo il tempo computazionale.
...
for d in */
	do
		...
		python ~/NGS_TOOLS/iEVA/iEVA/__main__.py \
		-Ref $REF \
		-I ~/Scrivania/VCF-IEVA/CANCER/$extract\_*FreeBayes*.vcf \
		-L /media/jarvis/HD1/VCF_Ann_iEVA_Cancer/$d/$extract.list \
		-O /media/jarvis/HD1/VCF_Ann_iEVA_Cancer/$extract\_Cancer_iEVA_FreeBayes.vcf \
		-SNVmbq 0 \
		-INDELmbq 0 \
		-SNVmmq 0 \
		-INDELmmq 0 \
		...
		python ~/NGS_TOOLS/iEVA/iEVA/__main__.py \
		-Ref $REF \
		-I ~/Scrivania/VCF-IEVA/CANCER/$extract\_*VarScan*.vcf \
		-L /media/jarvis/HD1/VCF_Ann_iEVA_Cancer/$d/$extract.list \
		-O /media/jarvis/HD1/VCF_Ann_iEVA_Cancer/$extract\_Cancer_iEVA_VarScan.vcf \
		-SNVmbq 0 \
		-INDELmbq 0 \
		-SNVmmq 0 \
		-INDELmmq 0 \
		...
		python ~/NGS_TOOLS/iEVA/iEVA/__main__.py \
		-Ref $REF \
		-I ~/Scrivania/VCF-IEVA/CANCER/$extract\_*GATK*.vcf \
		-L /media/jarvis/HD1/VCF_Ann_iEVA_Cancer/$d/$extract.list \
		-O /media/jarvis/HD1/VCF_Ann_iEVA_Cancer/$extract\_Cancer_iEVA_GATK.vcf \
		-SNVmbq 0 \
		-INDELmbq 0 \
		-SNVmmq 0 \
		-INDELmmq 0 \
